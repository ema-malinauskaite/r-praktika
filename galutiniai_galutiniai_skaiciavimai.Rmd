...
atom_types <- paste0(e, "_mut2_beHISLYS_PROPRO_TRPTRP_PROTRP_") # Pavadinimo dalis, kuri nusako koks atomu grupavimo tipas, bei kita info
#---- 
...
A <- matricu_lenteles$visu_baltymu_kont_sumu_skirtumai_atom %>% .[,-c(144, 204,208, 225)] 
...
apsk_absoliucios_temp_is_visu <- 
  absoliucios_kontaktu_reiksmes$visu_baltymu_kont_sumos_absoliucios[,-c(144, 204, 208, 225)] %*% tls_sprendimas_visi_baltymai
...
```{r}
kontaktu_sumos_ir_visa_kita <- cbind(absoliucios_kontaktu_reiksmes$visu_baltymu_kont_sumos_absoliucios[,-c(144, 204, 208, 225)], apsk_ir_teor_absoliucios_temp_is_visu)
