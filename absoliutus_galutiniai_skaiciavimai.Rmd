...
atom_types <- paste0(atom_types_parsiuntimui, "__BAKIUI_pasalinus_110_111_116_119") # Pavadinimo dalis, kuri nusako koks atomu grupavimo tipas, bei kita info
...
#------
r2_is_visu_lm <- lm(apsk_temp_absoliutusTLS ~ Tm, data=apsk_ir_teor_temp_absoliutusTLS_is_visu)
r2_is_visu <- summary(r2_is_visu_lm)$r.squared 

 saveRDS(r2_is_visu, file = 
   paste0("rds-failai/r2_is_visu_abs_",atom_types,".rds"))
